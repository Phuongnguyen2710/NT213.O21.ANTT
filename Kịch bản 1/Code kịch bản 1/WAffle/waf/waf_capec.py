...
def isinwhitelist(path, body, cookie):
    for val in whitelist:
        # Check if path matches the whitelist pattern
...
def prediction(url):    
    K.clear_session()
    #model = load_model('/home/kali/Desktop/NT213.O21.ANTT/CSIC-2010-dataset/ArchitectureB/TestCase[2345]/model.h5')
    #model = load_model('/home/kali/Desktop/NT213.O21.ANTT/CSIC-2010-dataset/ArchitectureA/TestCase7/model.h5')
    #model = load_model('/home/kali/Desktop/model.h5')
    model = load_model('/home/kali/Desktop/NT213.O21.ANTT/CAPEC-dataset/ArchitectA/Testcase2/model.h5')
    #model = load_model('/home/kali/Desktop/NT213.O21.ANTT/CAPEC-dataset/ArchitectB/Testcase[2345]/model.h5')
